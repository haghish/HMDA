#' Adolescents who report suicide attempt vs. suicidal ideation
#'
...
#'
#' @docType data
#' @name ideation_suicide
#' @usage data(ideation_suicide)
#' @format A data frame with 1612 rows and 429 variables, addressing the following domains.
...
#' }
#'
#' @details This dataset is part of the NSD study "Ung i Norge 2002" as documented in the Surveybanken.
...
#'
#' @source \url{https://doi.org/10.18712/NSD-NSD1882-V1}
#' @references OsloMet. (2012). Young people in Norway 2002 (Version 1) [Dataset].
